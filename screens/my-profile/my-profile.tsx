...
import { fetchUserProfile, UserProfile } from "../../api/profile/profile";
  ...
  useEffect(() => {
    const loadProfile = async () => {
      try {
        ...
        // Decoding the user ID from the token (assuming JWT)
        const decodedToken: any = jwtDecode(token);
        const userId = decodedToken?.user_id; // Adjust based on your JWT structure
